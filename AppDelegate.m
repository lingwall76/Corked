...
{
   [[UINavigationBar appearance] setBackgroundImage:[UIImage imageNamed:@"CorkedLogo.png"]
                                      forBarMetrics:UIBarMetricsDefault];
    
    [Parse setApplicationId:@"t74x5N2TkKk1bvOsjzpRfQfmXLIlOzZK8jqxQiht"
                  clientKey:@"mKqMLyOto3fIweXpgV44r5bo4xpRNImib9FlUGnc"];
